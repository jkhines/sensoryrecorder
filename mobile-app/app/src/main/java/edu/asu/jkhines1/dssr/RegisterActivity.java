...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Attempts register the account specified by the registration form.
    ...
    public class UserRegistrationTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserRegistrationTask(String email, char[] password) {
            mEmail = email;
            mPassword = password;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                Tokens tokens =
                        TokenHelper.clientCredentialsFlow(ApplicationConfig.AUTH_SERVER_URL,
                                ApplicationConfig.CLIENT_ID, ApplicationConfig.CLIENT_SECRET);

                // Use the client access token to register the new user.
                String response =
                        TokenHelper.registerUser(ApplicationConfig.API_SERVER_URL, mEmail, mPassword,
